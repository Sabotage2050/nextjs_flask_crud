...
locals {
  ecr_frontend_repository_name           = "flask-nextjs-kizi-next"
  ecr_backend_middleware_repository_name = "flask-nextjs-kizi-backend-nginx"
  ecr_backend_app_repository_name        = "flask-nextjs-kizi-backend-flask"
}
#todo refactor
...
locals {
  ...
  backend_task_app_container_name = "${local.app_name}-app-container-fastapi-backend"
}
